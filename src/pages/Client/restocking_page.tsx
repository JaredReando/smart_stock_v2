...
const Client: React.FC = () => {
    ...
    const getRecord = useCallback( (direction: 'prev' | 'next') => {
    ...
    <Container>
        ...
        <Section>
            <Row
                ...
                justifyContent="center"
            >
                <img src="https://img.icons8.com/wired/64/000000/move-stock.png" alt="move stock"/>
            </Row>
            <Box
                ml={4}
                flexGrow={1}
        ...
        <Box>
            <h1>Buttons</h1>
            <button
                onClick={() => setRecord(getRecord('prev'))}
            >
                PREV
            </button>
            <button
                onClick={() => firebase.doUpdateRestockRecord(record, testRecord)}
            >
                TEST
            </button>
            <button
                onClick={() => setRecord(getRecord('next'))}
            >
                NEXT</button>
        </Box>
    </Container>
